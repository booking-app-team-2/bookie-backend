...
VALUES (nextval('sequence_availability_period'), 15, date_part('EPOCH', current_date - 2),
        date_part('EPOCH', current_date + 4), false);

INSERT INTO availability_period (id, price, start_date, end_date, is_deleted)
VALUES (nextval('sequence_availability_period'), 20, date_part('EPOCH', current_date + 10),
...
VALUES (nextval('sequence_availability_period'), 10, date_part('EPOCH', current_date - 5),
        date_part('EPOCH', current_date - 1), false);
...
INSERT INTO reservation (id, number_of_guests, status, accommodation_id, reservee_id, start_date, end_date, price,
                         is_deleted)
VALUES (nextval('sequence_reservation'), 4, 'Accepted', 1, 3, date_part('EPOCH', current_date + 5),
        date_part('EPOCH', current_date + 9), 300, false);

INSERT INTO reservation (id, number_of_guests, status, accommodation_id, reservee_id, start_date, end_date, price,
                         is_deleted)
VALUES (nextval('sequence_reservation'), 2, 'Accepted', 1, 3, date_part('EPOCH', current_date + 13),
        date_part('EPOCH', current_date + 15), 120, false);
